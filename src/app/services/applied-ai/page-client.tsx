...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "Production-grade AI systems deployed within your infrastructure with full observability, compliance, and governance. Built to operate at scale without compromising reliability.",
    icon: Cpu,
  },
  {
